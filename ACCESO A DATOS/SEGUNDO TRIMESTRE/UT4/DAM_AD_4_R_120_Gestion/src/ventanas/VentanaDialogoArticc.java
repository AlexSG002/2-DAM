...
protected boolean validardatos() {
	...
	try{
	     descuento = Float.parseFloat(descartic.getText());
	  }catch (NumberFormatException e)
		{
		  mensaje = mensaje + "Precio de descuento err�neo. ";
		}
...
public void insertararticulo() {
	  ...
	  try{
		  ...
		  descartic.setText(String.valueOf(arti.getDescuento()));

		}catch (IndexOutOfBoundsException i){ 	
		    // a�adimos el articulo
			Articulos artinue = new Articulos (codarti,denom,stock,pvp, descuento);
			odb.store(artinue);
			odb.commit();
