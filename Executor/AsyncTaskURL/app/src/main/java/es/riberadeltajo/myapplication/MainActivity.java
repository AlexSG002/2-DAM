...
public class MainActivity extends AppCompatActivity {
    ...
    private static TextView contador;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Establecemos el contador de imágenes a 0.
                cambiarContador(0);
    ...
    //Método para cambiar el texto del contador al que le pasamos un entero que cuente las imágenes, este método lo ejecutaremos en la Secondary Activity y al resetear.
    public static void cambiarContador(int contadorImagenes){
        contador.setText(contadorImagenes+"/3 imágenes añadidas");
    }
